...
All of these are in `notes/` and describe completed or in-progress UI work:
...
If you need to go deeper on any system, the full documentation is at `documentation/`:
