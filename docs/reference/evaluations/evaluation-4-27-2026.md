...
| Documentation updated for vertex format, material flags, normal map system, outliner APIs | `docs/reference/15-3d-rendering-system.md`, `docs/reference/11-services-managers.md` |
